...
nghia_ahk_link = os.path.join(startup, "temp")
nghia_ahk_link = os.path.join(nghia_ahk_link, "nghia-windows-autohotkey2.ahk")
print(f"🚀 {nghia_ahk_link}")

nghia_ahk = os.path.join(os.getcwd(), "nghia-windows-autohotkey2.ahk")
print(f"🚀 {nghia_ahk}")
